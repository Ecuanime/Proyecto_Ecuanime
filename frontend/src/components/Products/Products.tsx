        ...
        const mockProducts: Product[] = [
          {
            ...
            price: 30000,
            image:
              " https://i.postimg.cc/kghkWppY/portada-tipo-polo-catalogo.jpg",
            category: "Hombre",
            description:
          ...
          },
          {
            ...
            price: 9800,
            image:
              "https://i.postimg.cc/zfrkppSN/portada-boxers-catalogo.jpg",
            category: "Hombre",
            description:
          ...
          },
          {
            ...
            price: 20000,
            image:
              "https://i.postimg.cc/7ZGPP8cH/portada-camisetas-dama-catalogo.jpg",
            category: "Mujer",
            description:
          ...
          },
          {
            ...
            price: 20000,
            image:
              "https://i.postimg.cc/3xGzym3W/portada-camisetas-hombre-catalogo.jpg",
            category: "Hombre",
            description:
          ...
          },
          {
            ...
            price: 30000,
            image:
              "https://i.postimg.cc/1zXvP0sk/portada-camisetas-oversize-catalogo.jpg",
            category: "mujer",
            description:
          ...
          
          {
            ...
            price: 37000,
            image:
              "https://i.postimg.cc/BQWf5Lw0/portada-catalog-buzos.jpg",
            category: "Buzos",
            description:
            ...
            <div className={styles.modalInfo}>
              ...
              {selectedProduct.sizes && selectedProduct.sizes.length > 0 && (
                <div className={styles.modalSizes}>
                  ...
                  <ul className={styles.modalSizesList}> {/* Añadimos una clase para la lista en el modal */}
