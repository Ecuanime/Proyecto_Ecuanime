  ...
  return (
    <>
      ...
      <main className={styles.termsPage}>
        <div className="container"> {/* Asumiendo que 'container' es una clase global o de Bootstrap */}
          ...
          <div className={styles.content}>
            ...
            <section id="introduccion-general" className={styles.section}>
              ...
              <p>
                <strong>ECUÁNIME Moda</strong> es el aliado ideal para emprendedores y tiendas de moda que buscan productos con estilo,
              ...
              <p>
                Estos términos y condiciones rigen el uso de nuestro sitio web (www.tuurldelsitio.com) y los servicios y productos que ofrecemos.
                Al acceder y utilizar nuestros servicios, usted acepta estos términos y condiciones en su totalidad. Por favor, léalos detenidamente.
              </p>
            </section>
            ...
            <section id="definiciones" className={styles.section}>
              ...
              <p>
                "Nosotros", "nuestro", "ECUÁNIME Moda" se refiere a [Razón Social Completa de ECUÁNIME Moda si es diferente], identificada con NIT [Tu NIT], con domicilio principal en Calle 42 c # 90 a - 12 interior 204 La América, Medellín, Colombia. "Usted", "cliente", "usuario" se refiere al visitante o usuario de nuestro sitio web y/o cliente de nuestros servicios.
              </p>
            </section>
            {/* ... (Continuar con tus secciones de Uso del Sitio, Propiedad Intelectual, etc.) ... */}
            ...
            <section id="politica-tratamiento-datos" className={styles.section}>
              ...
              <p>
                <strong>ECUÁNIME Moda</strong>, en cumplimiento de la Ley Estatutaria 1581 de 2012 de Protección de Datos Personales y sus decretos reglamentarios, informa que es responsable del tratamiento de los datos personales que usted suministre.
              </p>
            ...
            <section id="terminos-mayorista" className={styles.section}>
              ...
              <p>
                Los presentes términos y condiciones aplican específicamente para clientes que realicen compras al por mayor con <strong>ECUÁNIME Moda</strong>. Al realizar un pedido mayorista, usted acepta estos términos.
              </p>
            ...
            <section className={styles.section}>
              ...
              <p>
                Estos términos y condiciones se rigen e interpretan de acuerdo con las leyes de la República de Colombia. Cualquier
                disputa relacionada con estos términos y condiciones estará sujeta a la jurisdicción exclusiva de los
                tribunales de la ciudad de Medellín, Antioquia, Colombia.
              </p>
            </section>

            <section id="contacto-terminos" className={styles.section}>
              <h2>Contacto para Dudas sobre Términos</h2>
              <p>Si tiene alguna pregunta sobre estos términos y condiciones generales, la política de tratamiento de datos, o los términos mayoristas, por favor contáctenos a través de:</p>
              <p>
